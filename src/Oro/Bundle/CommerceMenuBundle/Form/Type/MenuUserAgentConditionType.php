...
class MenuUserAgentConditionType extends AbstractType
{
    ...
    {
        return [
            'contains' => 'oro.commercemenu.menu_user_agent_condition.operation.contains.label',
            'does_not_contain' => 'oro.commercemenu.menu_user_agent_condition.operation.does_not_contain.label',
            'matches' => 'oro.commercemenu.menu_user_agent_condition.operation.matches.label',
            'does_not_match' => 'oro.commercemenu.menu_user_agent_condition.operation.does_not_match.label',
        ];
    }
}
