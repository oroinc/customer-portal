...
class GlobalAjaxMenuController extends AbstractAjaxMenuController
{
    ...
    #[Route(path: '/reset/{menuName}', name: 'oro_commerce_menu_global_menu_ajax_reset', methods: ['DELETE'])]
    #[\Override]
    ...
    #[Route(
        ...
        name: 'oro_commerce_menu_global_menu_ajax_create',
        methods: ['POST']
    )]
    #[\Override]
    ...
    #[Route(path: '/delete/{menuName}/{key}', name: 'oro_commerce_menu_global_menu_ajax_delete', methods: ['DELETE'])]
    #[\Override]
    ...
    #[Route(path: '/show/{menuName}/{key}', name: 'oro_commerce_menu_global_menu_ajax_show', methods: ['PUT'])]
    #[\Override]
    ...
    #[Route(path: '/hide/{menuName}/{key}', name: 'oro_commerce_menu_global_menu_ajax_hide', methods: ['PUT'])]
    #[\Override]
    ...
    #[Route(path: '/move/{menuName}', name: 'oro_commerce_menu_global_menu_ajax_move', methods: ['PUT'])]
    #[\Override]
