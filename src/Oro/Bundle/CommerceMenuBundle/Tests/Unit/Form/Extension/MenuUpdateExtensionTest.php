...
class MenuUpdateExtensionTest extends FormIntegrationTestCase
{
    ...
    protected function getExtensions()
    {
        ...
        $menuUpdateExtension = new MenuUpdateExtension();
        $menuUpdateExtension->setWebCatalogProvider($this->webCatalogProvider);
            ...
            new PreloadedExtension(
                [
                    ...
                    ContentNodeSelectType::class =>
                        new ContentNodeSelectType($this->createMock(ContentNodeTreeHandler::class)),
                ...
                [
                    MenuUpdateTypeStub::class => [$menuUpdateExtension],
                    FormType::class =>
