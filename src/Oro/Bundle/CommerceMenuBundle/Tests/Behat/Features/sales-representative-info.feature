...
#  Demonstrate how sales reps can choose one of the enabled options (when "allow user configuration" is on) and how that leads to showing different contact info on the store frontend.
  ...
  Scenario: System level - Allow User Configuration
    ...
    Then "Customer Visible Contact Info" was set to "Don't Display Contact Info" and is not editable
    And go to System/ Configuration
    And click "Commerce"
    And click Sales in sidebar menu
    And click on "Contacts"
    ...
    And should see "Don't Display Contact Info" entity for "Customer Visible Contact Info" select
    And should see "Use My Profile Data" entity for "Customer Visible Contact Info" select
    And should see "Enter Manually" entity for "Customer Visible Contact Info" select
    When fill "Customer Visible Contact Info Form" with:
    ...
    And click Sales in sidebar menu
    And click on "UserContacts"
    Then I should not see "Don't Display Contact Info" entity for "Customer Visible Contact Info" select
    And I should not see "Use My Profile Data" entity for "Customer Visible Contact Info" select
    And should see "Enter Manually" entity for "Customer Visible Contact Info" select
