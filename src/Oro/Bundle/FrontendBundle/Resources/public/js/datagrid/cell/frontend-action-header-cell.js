...
import actionHeaderCellLabel from '!tpl-loader!orofrontend/templates/datagrid/action-header-cell-label.html';
import textUtil from 'oroui/js/tools/text-util';
import util from 'orodatagrid/js/datagrid/util';
...
export default FrontendActionHeaderCell;
