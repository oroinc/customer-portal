define(function(require) {
    ...
    require('tpl!orofrontend/default/templates/ui/message-item.html');
    require('tpl!orofrontend/default/templates/datagrid/column-manager-collection.html');
    require('tpl!orofrontend/default/templates/datagrid/column-manager-item.html');
    require('tpl!orofrontend/default/templates/datagrid/column-manager-filter.html');
    require('tpl!orofrontend/default/templates/datagrid/column-manager.html');
    require('tpl!orofrontend/default/templates/datagrid/pagination-input.html');
    require('tpl!orofrontend/default/templates/datagrid/page-size.html');
    require('tpl!orofrontend/default/templates/datagrid/visible-items-counter.html');
    require('tpl!orofrontend/default/templates/datagrid/select-all-header-cell.html');
    require('tpl!orofrontend/default/templates/datagrid/select-row-cell.html');
    require('tpl!orofrontend/default/templates/datagrid/action-header-cell.html');
