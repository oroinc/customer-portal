define([
    ...
    $.widget('oroui.rowCollapseWidget', $.oroui.collapseWidget, {
        ...
        _applyStateOnTrigger: function(isOpen) {
            if (isOpen) {
                this.$trigger.find('[data-collapse-text]').text(_.__('oro_frontend.rows_collapse.trigger.label.normal'));
            } else {
                this.$trigger.find('[data-collapse-text]').text(_.__('oro_frontend.rows_collapse.trigger.label.truncated', {
