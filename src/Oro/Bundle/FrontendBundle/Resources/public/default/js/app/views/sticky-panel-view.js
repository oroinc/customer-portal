define(function(require) {
    ...
    StickyPanelView = BaseView.extend({
        ...
        delegateListeners: function() {
            ...
            this.$document.on('ajaxComplete', _.bind(this.reset, this));
        },
            ...
            if (!options.alwaysInSticky && options.$elementPlaceholder) {
                if (state) {
                    ...
                    if (options.moveToPanel) {
                        this._checkPlaceholder(options.$placeholder);
        ...
        /**
         * Clean placeholder if need
         * @param $placeholder
         * @private
         */
        _checkPlaceholder: function($placeholder) {
