...
Feature: New Field Display in Grid (Customer Portal)
  ...
  Scenario Outline: Add new field and mark as Display in Grid
    ...
    Examples:
      | Name                       | Field     | Module                 |
      | CustomerUser               | TestField | OroCustomerBundle      |
      | Customer                   | TestField | OroCustomerBundle      |
      | CustomerGroup              | TestField | OroCustomerBundle      |
      | CustomerUserRole           | TestField | OroCustomerBundle      |
