...
Feature: Legacy configuration options
  ...
  Scenario: Check legacy configuration options in System Configuration
    ...
    Then I should see "Page Templates"
    And I should see "This configuration applies to OroCommerce version 5.1 and below and is retained in the current version only for backward compatibility with legacy storefront themes. For newer themes starting with v6.0 and above, please configure this option under System > Theme Configuration."
