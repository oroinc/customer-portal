...
class HateoasTest extends FrontendRestJsonApiTestCase
{
    ...
    {
        $this->loadFixtures([
            '@OroFrontendBundle/Tests/Functional/ApiFrontend/DataFixtures/products.yml'
        ]);
    }
    ...
    {
        $this->loadFixtures([
            '@OroFrontendBundle/Tests/Functional/ApiFrontend/DataFixtures/products_for_pagination.yml'
        ]);
    }
