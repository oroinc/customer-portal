...
class WorkflowControllerTest extends WebTestCase
{
    ...
    public function testStartTransitionFormAction()
    {
        $crawler = $this->client->request(
            'GET',
            $this->getUrl('oro_frontend_workflow_start_transition_form', [
        ...
        $workflowItem->setEntityId($this->entity->getId())
            ->setWorkflowName(LoadWorkflowDefinitions::COMMERCE_WORKFLOW_FORMS);

        $this->assertTransitionFormSubmit($crawler, $workflowItem, 'data_value_one', [
