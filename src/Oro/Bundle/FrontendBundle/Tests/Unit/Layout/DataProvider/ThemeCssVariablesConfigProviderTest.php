...
final class ThemeCssVariablesConfigProviderTest extends TestCase
{
     ...
     */
    public function testOutputStylesVariables(array $configuration, array $expected): void
    {
        ...
        self::assertEquals($expected, $this->themeCssVariablesConfigProvider->getStylesVariables());
    }
