...
class WYSIWYGTypeExtensionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->extension->setSvgIconsSupportProvider($this->svgIconsSupportProvider);
    ...
    public function testConfigureOptionsWhenNoSvgIconsSupportProviderAndWithSingleTheme(): void
    {
        $themeName = 'theme1';
        $theme = new Theme($themeName);
        $themeLabel = 'Theme 1';
        ...
        $resolver = new OptionsResolver();
        $this->extension->setSvgIconsSupportProvider(null);
        $this->extension->configureOptions($resolver);
