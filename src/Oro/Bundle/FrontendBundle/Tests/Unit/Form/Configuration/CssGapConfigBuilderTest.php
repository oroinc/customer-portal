...
use Oro\Bundle\FrontendBundle\Form\Configuration\CssGapConfigBuilder;
use Symfony\Component\Asset\Packages;

final class CssGapConfigBuilderTest extends AbstractCssConfigBuilderTest
{
    protected function setUp(): void
    {
        ...
        $this->configBuilder = new CssGapConfigBuilder($packages, $this->translator);
    }

    public function testThatTypeConfigured(): void
    {
        self::assertEquals('css_gap', $this->configBuilder::getType());
    }
    ...
    protected function getSupportsDataProvider(): array
    {
        return [
            ['unknown_type', false],
            [CssGapConfigBuilder::getType(), true],
        ];
    }
