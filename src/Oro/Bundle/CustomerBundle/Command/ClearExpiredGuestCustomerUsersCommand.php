...
HELP
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        do {
            ...
            $rows = $selectQB->execute()->fetchAllAssociative();
            ...
            try {
                ...
                $connection->createQueryBuilder()
                    ...
                    ->setParameter('ids', $customerUserIds, Connection::PARAM_INT_ARRAY)
                    ->execute();
                ...
                if ($customerIds) {
                    $connection->createQueryBuilder()
                        ->delete('oro_customer')
                        ->where('id IN (:ids)')
                        ->setParameter('ids', $customerIds, Connection::PARAM_INT_ARRAY)
                        ->execute();
                }
