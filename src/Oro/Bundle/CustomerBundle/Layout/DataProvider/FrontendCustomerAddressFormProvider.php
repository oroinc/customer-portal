...
/**
 * Layout data provider for customer address forms in the storefront.
 *
 * Provides form instances and form views for creating and updating customer addresses.
 * It uses {@see FrontendCustomerTypedAddressType} to render address forms.
 */
class FrontendCustomerAddressFormProvider extends AbstractFormProvider
{
    public const ACCOUNT_ADDRESS_CREATE_ROUTE_NAME = 'oro_customer_frontend_customer_address_create';
    public const ACCOUNT_ADDRESS_UPDATE_ROUTE_NAME = 'oro_customer_frontend_customer_address_update';
    ...
    public function getAddressFormView(CustomerAddress $customerAddress, Customer $customer)
    {
        ...
        return $this->getFormView(FrontendCustomerTypedAddressType::class, $customerAddress, $options);
    }
    ...
    public function getAddressForm(CustomerAddress $customerAddress, Customer $customer)
    {
        ...
        return $this->getForm(FrontendCustomerTypedAddressType::class, $customerAddress, $options);
    }
