...
use Oro\Bundle\CustomerBundle\Tests\Unit\Stub\AddressCopierAwareAddressStub;
...
final class AddressCopierTest extends TestCase
{
    ...
    public function testCopyToAddressLinksCustomerAddress(): void
    {
        $fromAddress = new CustomerAddress();
        $toAddress = new AddressCopierAwareAddressStub();
    ...
    public function testCopyToAddressLinksCustomerUserAddress(): void
    {
