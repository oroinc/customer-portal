...
class VisitorIdentifierUtilTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals('visitor:sessionId654', VisitorIdentifierUtil::encodeIdentifier(0, 'sessionId654'));
    }

    public function testDecodeIdentifier(): void
    {
        self::assertSame([0, 'sessionId654'], VisitorIdentifierUtil::decodeIdentifier('visitor:sessionId654'));
    }

    public function testDecodeOldIdentifier(): void
    {
        self::assertSame([0, 'sessionId654'], VisitorIdentifierUtil::decodeIdentifier('visitor:256:sessionId654'));
    }
}
