...
use Oro\Bundle\CustomerBundle\EventListener\CustomerUserLoginAttemptsLogSubscriber;
...
class CustomerUserLoginAttemptsLogSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var CustomerUserLoginAttemptsLogSubscriber */
    private $listener;
    ...
    protected function setUp(): void
    {
        ...
        $this->listener = new CustomerUserLoginAttemptsLogSubscriber($container, $this->frontendHelper);
    }
    ...
    public function testGetSubscribedServices(): void
    {
        self::assertEquals(
            ...
            CustomerUserLoginAttemptsLogSubscriber::getSubscribedServices()
        );
    }
