...
class CustomerUserProfileEmailChangeListenerTest extends TestCase
{
    ...
    public function testAfterFlushWhenFeatureEnabled(): void
    {
        ...
        $translatedMessage = 'Email change verification initialized.';
        ...
        $this->translator->expects(self::once())
            ->method('trans')
            ->with('oro.customer.controller.customeruser.profile_email_initialized.message')
            ->willReturn($translatedMessage);
        $flashBag->expects(self::once())
            ->method('add')
            ->with('success', $translatedMessage);
