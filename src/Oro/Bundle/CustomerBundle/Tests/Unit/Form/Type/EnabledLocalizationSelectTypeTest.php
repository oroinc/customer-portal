...
class EnabledLocalizationSelectTypeTest extends FormIntegrationTestCase
{
    ...
    {
        $this->assertEquals('oro_customer_enabled_localization', $this->formType->getName());
    }

    public function testGetBlockPrefix()
    {
        $this->assertEquals('oro_customer_enabled_localization', $this->formType->getBlockPrefix());
    }
}
