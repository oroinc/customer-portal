...
class FrontendCustomerUserTypeTest extends CustomerUserTypeTest
{
    ...
    public function testOnPreSetData()
    {
        ...
        $formType->setWebsiteManager($this->websiteManager);
    ...
    public function testOnSubmit($customerUserId, Website $website = null, Website $expectedWebsite = null)
    {
        ...
        $this->formType->setWebsiteManager($this->websiteManager);
    ...
    public function testOnSubmitNoWebsiteManager()
    {
        $this->authorizationChecker->expects($this->any())
            ->method('isGranted')
            ->willReturn(false);
        ...
        $result = $form->isValid();
        $this->assertTrue($result);
        $this->assertEmpty($form->getData()->getWebsite());
    }
