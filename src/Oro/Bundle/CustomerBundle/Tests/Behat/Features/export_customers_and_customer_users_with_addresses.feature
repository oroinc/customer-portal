...
Feature: Export Customers and Customer Users with addresses
  ...
  Scenario: Export Customers
    ...
    And The last exported file contains the following data:
      | Id | Name      | Parent Id | Parent Name | Group Name | Owner Id | Owner Username | Tax code | Account Id | Internal rating Id | VAT Id | Addresses 1 Label | Addresses 1 Organization | Addresses 1 Name prefix | Addresses 1 First name | Addresses 1 Middle name | Addresses 1 Last name | Addresses 1 Name suffix | Addresses 1 Street | Addresses 1 Street 2 | Addresses 1 Zip/Postal Code | Addresses 1 City | Addresses 1 State | Addresses 1 State Combined code | Addresses 1 Country ISO2 code | Addresses 1 Address ID | Addresses 1 Phone | Addresses 1 Primary | Addresses 1 Validated At | Addresses 1 Customer Id | Addresses 1 Customer Name | Addresses 1 Owner Username | Payment term Label |
