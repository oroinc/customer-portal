...
Feature: Import Customer Addresses
  ...
  Scenario: Check import of valid addresses
    Given I fill template with data:
      | Label             | Organization | Name prefix | First name | Middle name | Last name | Name suffix | Street              | Street 2 | Zip\/Postal Code | City        | State | State Combined code | Country ISO2 code | Address ID | Phone             | Primary | Customer Id | Customer Name | Owner Username | Billing | Default Billing | Shipping | Default Shipping | Delete | Validated At |
      | Address A removed | ORO          |             |            |             |           |             | 111 Scenic Hwy      |          | 33844            | Haines City |       | US-FL               | US                |            |                   | 1       |             | Company A     | admin          | 1       | 1               | 1        | 1                | 1      |              |
      | Address A updated | ORO          |             |            |             |           |             | 222 Scenic Hwy      |          | 33855            | Haines City |       | US-FL               | US                |            |                   | 1       |             | Company A     | admin          | 1       | 0               | 1        | 1                |        | true         |
      | Address A added   | ORO          | Mr.         | John       |             | Doe       | Jr.         | 23400 Caldwell Road |          | 14608            | Rochester   |       | US-NY               | US                |            | (+1) 212 123 4567 | 0       |             | Company A     | admin          | 1       | 1               | 1        | 1                |        | 1            |
      | Address B added   | ORO          | Mr.         | John       |             | Doe       | Jr.         | 23400 Caldwell Road |          | 14608            | Rochester   |       | US-NY               | US                |            | (+1) 212 123 4567 | 0       |             | Company B     | admin          | 1       | 1               | 1        | 1                |        | yes          |
    When I open "Customer Addresses" import tab
    And I import file
