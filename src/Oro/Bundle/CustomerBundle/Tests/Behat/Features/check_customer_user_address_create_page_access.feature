...
Feature: Check customer user address create page access
  ...
  Scenario: Set permission to create address for current customer user only
    ...
    And select following permissions:
      | Customer Address      | View:Corporate (All Levels) | Create:None       | Edit:None | Delete:None | Assign:None |
      | Customer User Address | View:None                   | Create:User (Own) | Edit:None | Delete:None | Assign:None |
  ...
  Scenario: Set permission to create address for corporate customer user
    ...
    And select following permissions:
      ...
      | Customer User Address | View:None | Create:Corporate (All Levels) | Edit:None | Delete:None | Assign:None |
    And I save and close form
    Then I should see "Customer User Role has been saved" flash message
  ...
  Scenario: Set permission to view corporate users list
    ...
    When click Edit Buyer in grid
    And select following permissions:
      | Customer User | View:Corporate (All Levels) | Create:None| Edit:None | Delete:None | Assign:None |
    And I save and close form
    Then I should see "Customer User Role has been saved" flash message
  ...
  Scenario: Set corporate role for customer user address view and edit
    ...
    And select following permissions:
      | Customer Address      | View:Corporate (All Levels) | Create:None       | Edit:None                   | Delete:None | Assign:None |
      | Customer User         | View:Corporate (All Levels) | Create:None       | Edit:Corporate (All Levels) | Delete:None | Assign:None |
      | Customer User Address | View:Corporate (All Levels) | Create:User (Own) | Edit:Corporate (All Levels) | Delete:None | Assign:None |
    And I save and close form
    Then I should see "Customer User Role has been saved" flash message
  ...
  Scenario: Set department role for customer user address edit
    ...
    And select following permissions:
      | Customer Address      | View:Corporate (All Levels) | Create:None       | Edit:None                   | Delete:None | Assign:None |
      | Customer User         | View:Corporate (All Levels) | Create:None       | Edit:Corporate (All Levels) | Delete:None | Assign:None |
      | Customer User Address | View:Corporate (All Levels) | Create:User (Own) | Edit:Department (Same Level) | Delete:None | Assign:None |
    And I save and close form
    Then I should see "Customer User Role has been saved" flash message
  ...
  Scenario: Set user role for customer user address edit
    ...
    And select following permissions:
      | Customer Address      | View:Corporate (All Levels) | Create:None       | Edit:None                   | Delete:None | Assign:None |
      | Customer User         | View:Corporate (All Levels) | Create:None       | Edit:Corporate (All Levels) | Delete:None | Assign:None |
      | Customer User Address | View:Corporate (All Levels) | Create:User (Own) | Edit:User (Own)             | Delete:None | Assign:None |
    And I save and close form
    Then I should see "Customer User Role has been saved" flash message
