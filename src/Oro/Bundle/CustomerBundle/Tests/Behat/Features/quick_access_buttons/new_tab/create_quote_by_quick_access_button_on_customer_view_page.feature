...
Feature: Create quote by quick access button on customer view page
  ...
  As an administrator
  I want to create new quote from customer view page by quick access button using new tab
  ...
  Scenario: Create quote by click on quick access button
    ...
    And I set configuration property "oro_ui.quick_create_actions" to "new_tab"
