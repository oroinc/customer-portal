...
Feature: Create customer by quick access button on customer group view page
  ...
  Scenario: Quick creation buttons is disabled by default
  ...
  Scenario: Enable quick creations buttons
    When I go to System / Configuration
    And I follow "System Configuration/General Setup/Display Settings" on configuration sidebar
    Then I should see "Upcoming Changes"
    When uncheck "Use default" for "Enable Quick Creation Buttons" field
    And I check "Enable Quick Creation Buttons"
