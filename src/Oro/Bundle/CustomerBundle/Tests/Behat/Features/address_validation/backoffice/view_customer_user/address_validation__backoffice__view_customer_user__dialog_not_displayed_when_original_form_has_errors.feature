...
Feature: Address Validation - Backoffice - View Customer User - Dialog Not Displayed When Original Form Has Errors
  As an Administrator
  I should not see the address validation dialog when the view customer user form contains validation errors
