...
Feature: Address Validation - Backoffice - View Customer - Prevent Original Form Submit When Address Validation Dialog Canceled
  As an Administrator
