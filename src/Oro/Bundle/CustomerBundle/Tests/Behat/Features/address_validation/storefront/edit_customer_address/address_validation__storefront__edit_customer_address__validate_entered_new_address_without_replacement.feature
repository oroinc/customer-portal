...
Feature: Address Validation - Storefront - Edit Customer Address - Validate Entered New Address Without Replacement
  As an Buyer
  I should see that address validation dialog displayed and
  address details were not changed after address validation on edit customer address page
