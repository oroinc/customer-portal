...
Feature: Export Customer Users
  ...
  Scenario: Export Customer Users
    ...
    And Exported file for "Customer Users" contains the following data:
      |ID|Name Prefix| First Name |Middle Name| Last Name |Name Suffix|Birthday   | Email Address              |Customer Id| Customer Name              |Customer Parent Id |Customer Owner Id|Roles 1 Role                |Roles 2 Role         | Guest | Enabled | Confirmed |Owner Username|Website Id|Owner Id|
