...
Feature: Export Customer Users
  ...
  Scenario: Export Customer Users
    ...
    And Exported file for "Customer Users" contains the following data:
      |ID|Name Prefix| First Name |Middle Name| Last Name |Name Suffix|Birthday   | Email Address              |Customer Id| Customer Name              |Roles 1 Role                |Roles 2 Role         | Is Guest | Enabled | Confirmed |Owner Id|Website Id|
      ...
      |2 |           | Branda     |           | Sanborn   |           |10/02/1990 | BrandaJSanborn@example.org |1          | Company A                  |ROLE_FRONTEND_BUYER         |                     | 0        | 0       | 1         |1       |2         |
