...
Feature: Removing last role from the customer user on frontend
  ...
  Scenario: Remove last role from disabled user
    ...
    And I click "Save"
    Then I should see "Customer User has been saved" flash message and I close it
    And I click "Account Dropdown"
    And I click "Roles"
    ...
    And I scroll to top
    And I click "Save"
    Then I should see "Customer User Role has been saved" flash message and I close it
