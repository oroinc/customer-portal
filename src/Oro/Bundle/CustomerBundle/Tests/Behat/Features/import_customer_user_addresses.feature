...
Feature: Import Customer User Addresses
  ...
  Scenario: Data Template for Customer Addresses
    ...
    And I see Validated At column

  Scenario: Check import of valid addresses
    Given I fill template with data:
      | Label             | Organization | Name Prefix | First Name | Middle Name | Last Name | Name Suffix | Street              | Street 2 | Zip\/Postal Code | City        | State | State Combined code | Country ISO2 code | Address ID | Phone             | Primary | Customer User Id | Email Address            | Owner Username | Billing | Default Billing | Shipping | Default Shipping | Delete | Validated At |
      | Address A removed | ORO          |             |            |             |           |             | 111 Scenic Hwy      |          | 33844            | Haines City |       | US-FL               | US                |            |                   | 1       |                  | AmandaRCole@example.org  | admin          | 1       | 1               | 1        | 1                | 1      | No           |
      | Address A updated | ORO          |             |            |             |           |             | 222 Scenic Hwy      |          | 33855            | Haines City |       | US-FL               | US                |            |                   | 1       |                  | AmandaRCole@example.org  | admin          | 1       | 0               | 1        | 1                |        | false        |
      | Address A added   | ORO          | Mr.         | John       |             | Doe       | Jr.         | 23400 Caldwell Road |          | 14608            | Rochester   |       | US-NY               | US                |            | (+1) 212 123 4567 | 0       |                  | AmandaRCole@example.org  | admin          | 1       | 1               | 1        | 1                |        | 0            |
      | Address B added   | ORO          | Mr.         | John       |             | Doe       | Jr.         | 23400 Caldwell Road |          | 14608            | Rochester   |       | US-NY               | US                |            | (+1) 212 123 4567 | 0       |                  | NancyJSallee@example.org | admin          | 1       | 1               | 1        | 1                |        | true         |
    When I open "Customer User Addresses" import tab
    And I import file
