...
final class CustomerUserAddressDialogAddressValidationControllerTest extends WebTestCase
{
    ...
    {
        return [
            ['oro_customer_address_validation_customer_user_address', AccessLevel::NONE_LEVEL, 403],
            ['oro_customer_address_validation_customer_user_address', AccessLevel::GLOBAL_LEVEL, 200],
        ];
    }
}
