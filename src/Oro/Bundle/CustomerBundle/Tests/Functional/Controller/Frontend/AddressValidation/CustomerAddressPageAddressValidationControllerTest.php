...
final class CustomerAddressPageAddressValidationControllerTest extends WebTestCase
{
    ...
    {
        return [
            ['oro_customer_frontend_address_validation_customer_address', AccessLevel::NONE_LEVEL, 403],
            ['oro_customer_frontend_address_validation_customer_address', AccessLevel::GLOBAL_LEVEL, 200],
        ];
    }
}
