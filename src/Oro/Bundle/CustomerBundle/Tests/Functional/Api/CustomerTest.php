...
class CustomerTest extends RestJsonApiTestCase
{
    ...
    public function testGetListFilteredByCreatedAt()
    {
        ...
        self::assertContains('customer created now', $response->getContent());

        $response = $this->cget(
            ['entity' => 'customers'],
            ['filter[createdAt][lt]' => $customer->getCreatedAt()->format('c')]
        );
        self::assertNotContains('customer created now', $response->getContent());
    }
    ...
    public function testGetListFilteredByUpdatedAt()
    {
        ...
        self::assertContains('customer created now and updated', $response->getContent());
    }
        ...
        $data = [
            'data' => [
                ...
                'relationships' => [
                    ...
                    'internal_rating' => [
                        'data' => ['type' => 'customer_rating', 'id' => $internalRatingId]
                    ],
                    'group'           => [
                        'data' => [
    ...
    public function testGetRelationshipForGroup()
    {
        ...
        $this->assertResponseContains(
            [
                'data' => ['type' => 'customer_groups', 'id' => '<toString(@customer.1->group->getId())>']
            ],
            $response
        );
    }
    ...
    public function testGetRelationshipForUsers()
    {
        ...
        $this->assertResponseContains(
            [
                'data' => [
                    ['type' => 'customer_users', 'id' => '<toString(@default_customer_user->id)>']
                ]
            ],
            $response
        );
    ...
    public function testAddRelationshipForUsers()
    {
        ...
        $this->postRelationship(
            ...
            [
                'data' => [
                    ['type' => 'customer_users', 'id' => (string)$user2Id]
                ]
            ]
        );
    ...
    public function testDeleteRelationshipForUsers()
    {
        ...
        $this->deleteRelationship(
            ...
            [
                'data' => [
                    ['type' => 'customer_users', 'id' => (string)$user1Id]
                ]
            ]
        );
