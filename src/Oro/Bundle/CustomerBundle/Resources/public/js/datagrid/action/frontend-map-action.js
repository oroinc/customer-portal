import MapAction from 'oro/datagrid/action/map-action';
...
import template from 'tpl-loader!orocustomer/templates/datagrid/action/frontend-map-action.html';
import 'jquery';
...
export default FrontendMapAction;
