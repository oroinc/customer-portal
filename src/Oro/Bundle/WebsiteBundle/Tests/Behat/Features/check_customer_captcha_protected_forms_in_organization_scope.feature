...
Feature: Check customer captcha protected forms in organization scope
  ...
  Scenario: Enable CAPTCHA protection
    When I uncheck "Use System" for "Enable CAPTCHA protection" field
    And I check "Enable CAPTCHA protection"

    And uncheck "Use System" for "CAPTCHA service" field
    And I fill in "CAPTCHA service" with "Dummy"

    And uncheck "Use System" for "Protect Forms" field
