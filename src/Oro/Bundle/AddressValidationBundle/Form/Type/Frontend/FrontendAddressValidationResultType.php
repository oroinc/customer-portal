...
/**
 * Represents a list of suggested addresses to display for a user on storefront.
 */
class FrontendAddressValidationResultType extends AbstractType
{
    ...
    {
        return 'oro_address_validation_frontend_validation_result';
    }
}
