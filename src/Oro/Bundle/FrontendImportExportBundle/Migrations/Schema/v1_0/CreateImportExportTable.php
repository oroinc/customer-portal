...
namespace Oro\Bundle\FrontendImportExportBundle\Mirgations\Schema\v1_0;
...
/**
 * Migration to create table for FrontendImportExportResult entity.
 */
class CreateImportExportTable implements Migration
{
    /**
     * @inheritdoc
     */
